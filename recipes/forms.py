...
class RecipeForm(forms.ModelForm):
    name = forms.CharField(label="Name", widget=forms.TextInput(attrs={"class": "form-item"}),)
    ...
    ingredients = forms.CharField( max_length=600, required=False, widget=forms.TextInput(attrs={"class": "form-item", "placeholder": "e.g. ingredient1, ingredient2"}),)
    ...
    class Meta:
        model = Recipe
        fields = ['name', 'description', 'cooking_time', 'instructions', 'pic']
